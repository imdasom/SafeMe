...
import safeme.com.naver.cafe.safeme.obj.FootPosition;
 ...
 */
public class ReceiveFootDataCallback implements ProcessCallback {
    private static final int WHAT = Constants.GET_FOOTPOS_DATA;
    ...
    public void onPostExecute(Object... objects) {
        ...
        try {
            ...
            List<FootPosition> dataParsed = null;
            Parser.jsonArrayToJavaList(dataReceived, dataParsed);
            handler.sendMessage(HttpUtils.getMessage(ReceiveFootDataCallback.WHAT, dataParsed));
