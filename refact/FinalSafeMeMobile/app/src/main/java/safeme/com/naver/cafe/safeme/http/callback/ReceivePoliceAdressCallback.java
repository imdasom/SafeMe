 ...
 */
public class ReceivePoliceAdressCallback implements ProcessCallback {
    private static final int WHAT = Constants.GET_POLICE_ADDRESS;
    ...
    public void onPostExecute(Object... objects) {
        ...
        try {
            ...
            List<PoliceAddress> dataParsed = null;
            Parser.jsonArrayToJavaList(dataReceived, dataParsed);
            handler.sendMessage(HttpUtils.getMessage(ReceivePoliceAdressCallback.WHAT, dataParsed));
