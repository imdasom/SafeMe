...
<p align="center"><br>
<div align="center"><h1>신고게시판</h1>
<h1 style="font-size: 140%;">Notification Board</h1>
...
%>
                <tr>
                  ...
                  <td width="364" align="left" bgcolor="#FFFFFF"><p><font
                       size="2">&nbsp;&nbsp;&nbsp;</font><a href="sinkokyesipan_view1.jsp?bid=<%=b_id%>"><font
...
<%
        ...
        if(mypage!=1) {
                gopage=mypage-1;
                out.println("<a href=sinkokyesipan.jsp?mypage="+gopage+"><<이전</a>  ");
        } else {
		out.println("<<이전");
	}
%>
<%
        if(mypage!=pagecount) {
                gopage=mypage+1;
                out.println("<a href=sinkokyesipan.jsp?mypage="+gopage+">다음>></a>  ");
        } else {
		out.println("다음>>");
	}
} catch (Exception e) {
